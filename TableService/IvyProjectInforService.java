...
public class IvyProjectInforService {
    private EntityManager manager;
    public IvyProjectInforService(EntityManager manager){
        this.manager=manager;
    }
    public IvyProjectInforService() {
    ...
    public List<ProjectInfor> readsearch(String projectID){
        TypedQuery<ProjectInfor> query = manager.createQuery("SELECT e FROM ProjectInfor e WHERE e.projectID = :projectID", ProjectInfor.class);
         query.setParameter("projectID", projectID);
         
         List<ProjectInfor> result = query.getResultList();
         return result;
       }
    public ProjectInfor createProject(String projectID,String projectName,String projectDescription,String projectOutcome,String partnerName,String startDate,String endDate)
    {
