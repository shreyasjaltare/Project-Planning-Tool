...
public class ProjectInforTableModel extends AbstractTableModel {
	List<ProjectInfor> projectInforList;
	private static final String PERSISTENCE_UNIT_NAME ="PersistenceUnit"; 
	private static EntityManagerFactory factory; // JPA
	private EntityManager manager; // JPA
	private ProjectInfor project;// represents the entity
	private ProjectInforService service ;
	private int numcols, numrows;
	
	

	public ProjectInforTableModel() {
		super();
				factory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME);
				manager = factory.createEntityManager();
				project = new ProjectInfor();
				service = new ProjectInforService(manager);
	...
	public List<ProjectInfor> getList() {
	 ...
	 public ProjectInforTableModel(List<ProjectInfor> list, EntityManager em)  {
     ...
     {      
            List<ProjectInfor> searchList = service.search(Id);
            return searchList;
    }
