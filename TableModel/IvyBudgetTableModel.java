 ...
 * @author Ivy
 */
public class IvyBudgetTableModel extends AbstractTableModel{
	  ...
	  private IvyBudgetService budgetService;
	
	   // This field contains additional information about the results   
	    int numcols, numrows;           // number of rows and columns

	public IvyBudgetTableModel() {
	    factory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME);
	    manager = factory.createEntityManager();
	    budget = new Budget();
	    budgetService = new IvyBudgetService(manager);
	 ...
	 public IvyBudgetTableModel(List<Budget> list, EntityManager em)  {
