...
import TableModel.CommunicationTableModel;
 ...
 * @author Ivy
 */
public class CommunicationTableController implements ListSelectionListener, TableModelListener{
      private CommunicationTableModel tableModel;
	private CommunicationGUI gui;
	
	public CommunicationTableController(CommunicationGUI gui) {
		this.gui = gui;   
         // create the tableModel using the data in the cachedRowSet
    		tableModel = new CommunicationTableModel(); 
	...
	public void tableChanged(TableModelEvent e)
	{
	   try {
	        ...
	        tableModel = new CommunicationTableModel(tableModel.getList(), tableModel.getEntityManager());
	        tableModel.addTableModelListener(this);
